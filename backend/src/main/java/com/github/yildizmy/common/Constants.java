...
public final class Constants {
    ...
    public static final String NOT_FOUND_RECORD = "No records found";
    ...
    public static final String ALREADY_EXISTS_TYPE = "Type with the same name already exists";
    public static final String ALREADY_EXISTS_USER = "User with the same username already exists";
    public static final String CREATED_TYPE = "New type created";
    public static final String CREATED_PET = "New pet created";
    public static final String CREATED_USER = "User created";
